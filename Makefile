...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile Integration.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Integration1.0.0
DISTDIR = /home/yioannidis/Integration/.tmp/Integration1.0.0
LINK          = clang++
...
Makefile: Integration.pro ../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		Integration.pro
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile Integration.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Integration/bin || mkdir -p $(INSTALL_ROOT)/opt/Integration/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Integration/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Integration/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Integration/bin/ 
